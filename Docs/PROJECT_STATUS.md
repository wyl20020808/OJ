...
Team Assignment & Homework Wave 3F Main Integration V1 (2026-09-09): PARTIAL pending PostgreSQL qualification, real authorization/membership matrix, runtime smoke, and manual UI. Fresh candidate preserves Wave 3A/3C/3D/3E and adds team-bound Assignment/Homework lifecycle, normalized problem bindings, server-side role/status visibility, and submission-derived progress. See `Docs/reports/OJPLATFORM_TEAM_ASSIGNMENT_HOMEWORK_WAVE3_MAIN_INTEGRATION_REPORT.md`.
